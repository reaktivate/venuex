...
storiesOf('elements/buttons/OwnerStatus', module)
  ...
  .add('Assign', () => <OwnerStatus text="Assign owner" mode="assign" handleClick={action('Click')}/>)
  .add('Unassign', () => <OwnerStatus text="Unassign owner" mode="unassign" handleClick={action('Click')}/>)